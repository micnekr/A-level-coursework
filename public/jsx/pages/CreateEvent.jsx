...
function CreateEvent() {
    ...
    return <PageContainerBox title="Create an event">
      ...
      // Input the title of the group
          ...
          // Select recurrence of the group
          ...
          // Input the time when the activity starts
            <Form.Group className="mb-3" controlId="formBasicStartTime">
                ...
                <input type="datetime-local"
                    ...
                    onChange={e => {
                        // On change, make sure it does not start after it ends
