    ...
    return <PageContainerBox title="Create an event">
        <Form>
            ...
            <Form.Group className="mb-3" controlId="formBasicStartTime">
              ...
              // use input tag because react-bootstrap does not have a wrapper around it in this context
          ...
          // Select when this acticity ends
          ...
          // Select whether this event is public or not
          ...
          // Select the group selected for this event
