...
function Header() {
    ...
    */
    ...
    /** A button to be placed in the header
       Accepts props `link` to specify the url, `content` to specify the text to be displayed, `is_filled` to specify what it looks like
     */
